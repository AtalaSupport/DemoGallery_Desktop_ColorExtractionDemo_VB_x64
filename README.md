...
This is the VB.NET version. We also offer a [C# version.](https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_ColorExtractionDemo_CS_x64)  
...
```bash
git clone https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_ColorExtractionDemo_VB_x64.git ColorExtractionDemo --recursive
